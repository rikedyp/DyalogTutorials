...
|[Link](./application-development.md#link)|Store APL source code in Unicode text files, rather than binary workspace files, and synchronise them with the active workspace. Allows you to use external editors and source code management tools.|:material-web: [Link User Guide](https://dyalog.github.io/link)|
...
## [External data management and conversion](./external-data-management-conversion.md)
|Tool|Description|More Information|
|---|---|---|
|[SQAPL](./external-data-management-conversion.md#sql-interface)|Interface to ODBC data sources (SQL databases)|:fontawesome-solid-file-pdf: [SQL Interface Guide](http://docs.dyalog.com/latest/SQL%20Interface%20Guide.pdf)|
|vecdb \*|A very simple column-store management system|:fontawesome-brands-github: [Dyalog/vecdb](https://github.com/Dyalog/vecdb)|
|[⎕CSV](./external-data-management-conversion.md#csv)|Read data from CSV files and text as APL arrays; write APL arrays to CSV format and files|:material-web: [Comma Separated Values](http://help.dyalog.com/latest/#Language/System%20Functions/csv.htm)|
|[⎕JSON](./external-data-management-conversion.md#json)|Convert between APL arrays and JSON text|:material-web: [JSON Convert](http://help.dyalog.com/latest/#Language/System%20Functions/json.htm)|
|[⎕XML](./external-data-management-conversion.md#xml)|Convert between APL arrays and XML text|:material-web: [XML Convert](http://help.dyalog.com/latest/#Language/System%20Functions/xml.htm)|
...
|[⎕MAP](./external-data-management-conversion.md#map)|Treat files as APL arrays using memory mapping|:material-web: [Map File](http://help.dyalog.com/latest/#Language/System%20Functions/map.htm)|
...
|Py'n'APL \*|Bi-directional interface between [Python](https://www.python.org/) and Dyalog|:fontawesome-brands-github: [Dyalog/pynapl](https://github.com/Dyalog/pynapl)|
|[.NET](./external-language-interfaces-standard-libraries.md#net)|The .NET bridge supports .NET Framework and Core.<br>Create and use instances of .NET classes.<br>Define new .NET classes in Dyalog APL that can be used from other .NET languages such as C# using .NET Framework on Microsoft Windows.|:fontawesome-solid-file-pdf: [.NET Core Interface Guide](https://docs.dyalog.com/latest/dotNET%20Core%20Interface%20Guide.pdf)<br>:fontawesome-solid-file-pdf: [Dyalog for Microsoft Windows .NET Framework Interface Guide](https://docs.dyalog.com/latest/Dyalog%20for%20Microsoft%20Windows%20.NET%20Framework%20Interface%20Guide.pdf)<br>:fontawesome-solid-file-pdf: [Comparison of .NET Core/Framework Interfaces](https://docs.dyalog.com/latest/dotNET%20Differences.pdf)|
|[Microsoft OLE](./external-language-interfaces-standard-libraries.md#microsoft-office-ole-client)|Automate Microsoft Office automation and interact with COM/ActiveX objects embedded within applications from Dyalog APL.|:fontawesome-solid-file-pdf: [Chapter 9 of the Dyalog for Microsoft Windows Interface Guide](https://docs.dyalog.com/latest/Dyalog%20for%20Microsoft%20Windows%20Interface%20Guide.pdf#page=185)|
...
|Selenium Interface \*|Automate the use of web browsers using Selenium WebDriver.|:fontawesome-brands-github: [Dyalog/Selenium](https://github.com/Dyalog/Selenium)<br>:fontawesome-solid-file-pdf: [Driving Selenium from Dyalog APL](https://github.com/Dyalog/Selenium/raw/master/Selenium%20from%20Dyalog.pdf)
...
|Tool|Description|More Information|
|---|---|---|
|[Spawn](./asynchronous-programming.md#the-spawn-operator)|The Spawn operator `&` is a lightweight method to launch "[green threads](https://en.wikipedia.org/wiki/Green_thread)" for doing multiple time-consuming (but not compute-heavy) tasks in parallel.|:material-web: [Spawn](https://help.dyalog.com/latest/#Language/Primitive%20Operators/Spawn.htm)|
|[Futures and Isolates](./asynchronous-programming.md#futures-and-isolates) \*|Execute code in parallel CPU threads on one or more machines|:fontawesome-solid-file-pdf: [Parallel Language Features Guide](http://docs.dyalog.com/latest/Parallel%20Language%20Features.pdf)|
